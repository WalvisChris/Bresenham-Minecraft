...
|------------|-------|-------------|---------|---------|--------|--------|-------|--------------|
| start | | | | | | | **-10** | **(22, 18)** |
| 0 | (-10) yes | (4>18) no |   | x | x |   | -10 + 8 = **-2**  | (22, 18) + (-1, 0) = **(21, 18)** |
| 1 | (-2) yes  | (4>18) no |   | x | x |   | -2 + 8 = **6**    | (22, 17) + (-1, 0) = **(20, 18)** |
| 2 | (6) no    | (4>18) no | x | x |   | x | 6 + -28 = **-22** | (22, 16) + (-1, -1) = **(19, 17)** |
| 3 | (-22) yes | (4>18) no |   | x | x |   | -22 + 8 = **-14**  | (21, 15) + (-1, 0) = **(18, 17)** |
| .. |
